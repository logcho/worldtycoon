...
export default function Home() {
  return (
    <main className="h-dvh snap-y snap-mandatory overflow-y-auto scroll-smooth bg-[url('/images/backgrounds/bg.png')] bg-cover bg-center bg-no-repeat custom-scroll">
