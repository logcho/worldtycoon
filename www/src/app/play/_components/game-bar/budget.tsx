...
type BudgetProps = {
    ...
    write: () => void;
    setBudgeting: (input: boolean) => void;
    budgeting: boolean;
  };
  
/**
 * Budget management UI for adjusting tax and fund allocations.
 */
export const Budget: FC<BudgetProps> = ({
  ...
  }, [tax, rp, fp, pp, setInput, budgeting]);
      ...
      >
        <DialogTrigger asChild>
          <Button
            ...
            onClick={() => setBudgeting(!budgeting)}
          >
            Budget
          </Button>
        </DialogTrigger>
        <DialogContent className={`${fixedsys.className} bg-blue-600`}>
          <DialogHeader>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <DialogTrigger asChild>
              <Button disabled={loading} onClick={() => setBudgeting(!budgeting)}>
                Okay
              </Button>
            </DialogTrigger>
          </div>
